<template>
  <div class="h-[500px] w-[800px] mx-auto relative">
    <div v-if="isShowBtnLogin" class="thumnail absolute top-0 left-0 z-20 h-full w-full">
      <div class="image">
        <img
      ...
      <div class="fb_login_button_container">
        <div class="fb">
          <button class="fb_button_label_element fb_button_label" @click="onRedirectLogin()">
            <svg
              viewBox="0 0 213 213"
